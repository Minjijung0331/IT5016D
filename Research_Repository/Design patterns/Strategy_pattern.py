# Strategy pattern defines define a family of algorithms, and make them interchangeable.
...
# Descriptor class for validating and applying discount strategies
class DiscountStrategyValidator:
    @staticmethod
    def validate(obj: Order, value: Callable) -> bool:
        try:
            # Check if the discount results in a negative price
    ...
    def __set__(self, obj: Order, value: Callable = None) -> None:
        # Set the discount strategy after validation
...
# Order class representing an order with a price and discount strategy
class Order:
    # Applying the DiscountStrategyValidator as a descriptor
    ...
    def apply_discount(self) -> float:
        # Apply the discount strategy if available, otherwise, no discount
...
def main():
    ...
    # Create an order with a 10% discount strategy
    ...
    # Create an order with an on-sale discount strategy
    ...
    # Try to create an order with a discount resulting in a negative price
