...
print("In uppercase:\n")
print("I think there is a world market for maybe five computers.".upper())

print("In lowercase:\n")
print("I think there is a world market for maybe five computers.".lower())

print("As a title:\n")
print("I think there is a world market for maybe five computers.".title())
